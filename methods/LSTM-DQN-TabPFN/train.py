...
def main():
    ...
    # Synthesize one extra transition per alternative action via predict_with_tabpfn,
    # which takes [state | action] as a flat feature vector. Non-terminal transitions
    # are not augmented.
